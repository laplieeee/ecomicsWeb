                        ...
                        <form id="myform1" name="form1" role="form" method="post" action="?login=chk" onSubmit="return remember()" >
                            <fieldset>
								...
								<div class="form-group has-feedback">
                                    <input class="form-control css-require" placeholder="Username" name="user" type="text" autocomplete="off" 
                                    value="<?php echo $_COOKIE['CK_username']?>">
                                ...
                                <div class="form-group">
								<div class="form-group has-feedback">
                                    <input class="form-control css-require" placeholder="Password" name="pass" type="password" value="<?php echo
                                     $_COOKIE['CK_password']?>">
									<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
									</div>
                                </div>
