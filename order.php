...
$conn->query("update product set Pro_Amount = Pro_Amount-'$show2[Car_Amount]' where Pro_ID = '$show2[Pro_ID]'")or die ($conn->error());
...
<input type="hidden" name="total_price" value="<?php echo $total_all;?>">
          ...
          <div class="panel panel-primary">
                  ...
                  <div class="col-lg-7">
                  <div class="form-group has-feedback">
                  <label class="control-label col-lg-5"><img src='images/slip.png'></label>
                  </div>
                  </div>
                  </div>
          ...
          <tr>
          <td colspan="12">
            <div class="text-right"><button type="submit" class="btn btn-primary btn-grad btn-xl" 
            onClick="return confirm ('ยืนยันการสั่งซื้อ');">ยืนยันการสั่งซื้อ</button>&nbsp;<button type="button" 
            class="btn btn-danger btn-grad" onClick="window.location='?data=cancel';">ยกเลิกรายการทั้งหมด</button></div>
