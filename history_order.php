...
?>
                  ...
                  <td class="small"><div align="center"><?php echo $status;?></div></td>
                   <td class="small"><div align="center"><a href="chillpay.html" target="_blank" class="btn btn-primary">View Order</a></div></td>
                    <td class="small"><div align="center">
                    <?php if($show['Ord_Status']==0 or $show['Ord_Status']==1){?>	
                    <a href="conpp.php?id=<?php echo $show['Ord_ID'];?>" class="btn btn-success">ชำระเงิน</a>
                    <?php } else {echo '-';}?>
                    </div></td>
